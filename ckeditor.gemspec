...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-06-01}
  s.description = %q{CKEditor is a text editor to be used inside web pages. Its a WYSIWYG editor, which means that the text being edited on it looks as similar as possible to
